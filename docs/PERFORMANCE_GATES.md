...
Phase 7 turns Typstry's existing incremental language analysis and virtual PDF viewer into measured contracts. Metrics are printed to the web developer console and appear in the Dev log tab when Developer mode is enabled.
...
5. Record the Typstry, WebView, renderer/GPU, and Tinymist process memory after a complete scroll.
