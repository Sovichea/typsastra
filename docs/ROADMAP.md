...
- More robust WYSIWYM editing behavior for block-level Typst structures.
- Global project-wide search.
- Advanced Git integration.
- Integrated Typst package manager UI.
- Broader macOS release verification.
- More language providers and better tokenizer-backed support for complex scripts.
- Optional AI/copilot-style Typst drafting and completion support.
