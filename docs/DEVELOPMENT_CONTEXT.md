...
- Language providers can be enabled or disabled in Editor settings. `editor.languageProviders: null` means all installed providers are active; an explicit array stores selected provider IDs and applies to both spellcheck and typing word suggestions.
