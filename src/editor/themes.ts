...
export const unicodeLayoutTheme = EditorView.theme({
  ...
  ".cm-content": { fontFamily: "'Fira Code', monospace", fontSize: "15px", padding: "10px 0" },
...
export const typstSyntaxHighlighting = HighlightStyle.define([
  ...
  { 
    ...
    color: "#ce9178",
    fontFamily: "system-ui, -apple-system, 'Noto Sans Arabic', 'Noto Sans Khmer', 'Noto Sans Devanagari', sans-serif"
  }
]);
